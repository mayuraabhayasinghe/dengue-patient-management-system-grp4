        ...
        <div className="flex items-center flex-col-reverse md:flex-row gap-5 w-full pt-2">
          ...
          <div className="flex flex-col gap-4 items-start w-[90%]">
            ...
            <p className="text-text-1">
              A web-based solution designed to revolutionize dengue patient care
              in Sri Lanka. Monitor patients in real time, manage hospital
              resources efficiently, and receive AI-driven insights for better
              decision-making.
            </p>
